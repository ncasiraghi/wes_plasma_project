...
tissue_haloplex_calls <- "/elaborazioni/sharedCO/Abemus_data_analysis/NimbleGen_SeqCapEZ_Exome_v3_Plasma_IPM/Strelka2/Tissue_HaloPlex/calls_strelka2.txt"

tissue_sureselect_calls <- "/elaborazioni/sharedCO/Abemus_data_analysis/NimbleGen_SeqCapEZ_Exome_v3_Plasma_IPM/Strelka2/Tissue_SureSelect/calls_strelka2.txt"

plasma_nimble_calls <- "/elaborazioni/sharedCO/Abemus_data_analysis/NimbleGen_SeqCapEZ_Exome_v3_Plasma_IPM/Strelka2/Plasma/calls_strelka2.txt"
